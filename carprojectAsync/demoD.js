...
// search('model','XGT').then(data=>console.log(data)).catch(err=>console.log(err.message));
// search('licence', 'ABC-1').then(data => console.log(data)).catch(err => console.log(err.message));
